...
const jobExecutor = createJobExecutor(
  {
    ...
    agentEgressNetwork: env.AGENT_EGRESS_NETWORK ?? env.AGENT_NETWORK_NAME,
    agentEgressProxyUrl: env.AGENT_EGRESS_PROXY_URL,
    agentControlNetwork: env.AGENT_CONTROL_NETWORK,
