...
import type { PromoteSeedDialogProps } from "../../domain/types";

const PRIORITY_OPTIONS: Priority[] = ["low", "medium", "high", "urgent"];

export const PromoteSeedDialog: React.FC<PromoteSeedDialogProps> = ({
  open,
  onOpenChange,
  form,
  item,
  ...
  const t = useTranslations("seeds.promoteDialog");
        ...
        >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setValue(
                    "workItemType",
                    value as "task" | "story" | "feature" | "epic",
                  )
                }
              >
                <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isPending}>
              {isPending ? t("promotingAction") : t("promote")}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
