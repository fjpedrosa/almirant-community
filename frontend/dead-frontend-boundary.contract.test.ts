...
const retiredRelativePaths = [
  ...
  "src/domains/planning/application/hooks/use-seed-detail.ts",
...
const retiredImportTargets = [
  "planning", "planning/application/hooks/use-seed-detail", "seeds", "shared/presentation/utils", "shared/application/hooks",
...
describe("dead frontend boundary", () => {
  ...
  it("normalizes retired import spellings without matching descendants", () => {
    const retired = [
      ...
      'import "@/domains/planning/application/hooks/use-seed-detail"',
      'import "./domains/planning/application/hooks/use-seed-detail"',
      'import "@/domains/planning/application/hooks/use-seed-detail?raw"',
      'import "@/domains/planning/application/hooks/use-seed-detail#hash"',
      'await import("./domains/planning/application/hooks/use-seed-detail/index")',
    ...
    const safe = [
      ...
      'import "@/domains/planning/application/hooks/use-seed-detail/child"',
      'const text = "@/domains/planning/application/hooks/use-seed-detail"',
      'import "@/domains/other/application/hooks/use-seed-detail"',
      'import { useSeedDetailPanel } from "@/domains/seeds/application/hooks/use-seed-detail-panel"',
